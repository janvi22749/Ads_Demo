    ...
    public void loadQureka(Activity activity, ViewGroup viewGroup, Boolean z) {
        ...
        cardQureka.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setToolbarColor(Color.parseColor(activity.getString(R.color.main))).setShowTitle(true);
...
//            webView.getSettings().setAppCacheEnabled(true);
    ...
    private static void ratingAppDialog(Activity activity, AdsCallBack adsCallingBack4) {
        ...
        dialog.findViewById(R.id.ivRate).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {
